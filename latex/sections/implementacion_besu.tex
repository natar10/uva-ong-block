...
El contrato \texttt{ONGDonaciones.sol} implementa un diseño modular con las siguientes estructuras de datos:
...
\begin{itemize}
    ...
    \item \texttt{cambiarEstadoProyecto(string proyectoId, EstadoProyecto nuevoEstado)}: Permite al owner cambiar el estado de un proyecto (Activo/Cancelado).
\end{itemize}
...
\begin{enumerate}
    ...
    \item Conexión de MetaMask a la red BLOCK LAB
...
\begin{itemize}
    ...
    \item \textbf{Coordinación frontend-contrato:} La dirección del contrato debe actualizarse manualmente en el archivo de configuración del frontend cada vez que se despliega una nueva versión.
