...
El código fuente de la aplicación esta disponible en el siguiente repositorio de GitHub: 
...
\subsection{\textit{Walktrhough} de la aplicación}

Primero, el usuario \textit{Donante} se registra en al plataforma, propocionando un nombre. Esto hará saltar la extensión de Metamask, donde el usuario deberá selecccionar la cuenta con la que se regitra a la red blockchain.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{./assets/screenshots/RegistroDonante.png}
\end{figure}
...
Gracias a las donacion, el donante recibirá votos, que podrá usar para votar para que se apruebe nuevos proyectos, cuando se supere el margen establecido.
...
\subsection{Walkthourgh \textit{Remix}}

El deploy de la apliación se realizó a través e Remix IDE, complicalóndolo con el compilador \textit{London}.
