...
\begin{itemize}
    \item \textbf{Gestión de proveedores:} El diseño inicial incluía un registro de proveedores autorizados (constructoras, distribuidores de material educativo, editoriales) con historial de compras. Este mecanismo fue eliminado para simplificar el flujo de fondos.
...
\begin{itemize}
    ...
    \item \textbf{Votación simplificada:} Los donantes pueden votar en cualquier momento, gastando sus tokens para incrementar el contador de votos del proyecto.
