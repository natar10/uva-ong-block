...
\begin{itemize}
    ...
    \item \textbf{Distribución porcentual automática:} El sistema original contemplaba que cada donación se distribuyera según porcentajes predefinidos (20\% a administración, 30\% equitativo entre proyectos sin meta, 50\% según votaciones). Este mecanismo complejo fue simplificado.
